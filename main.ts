...
import { retryOnTryAgainButton } from "./function/functions";
import XLSX from "xlsx";

import {
  getRandomPostalCode,
  getRandomBanNumber,
} from "./function/addressList";
...
const wb = XLSX.readFile("tixplus_ac.xlsx");
...
// // Run the program
// (async () => {
//   for (let i = 0; i < reg_list_json.length; i++) {
//     await runProgram(i, reg_list_json);
//   }
// })();
